    ...
    <section>
        <main class="form-signin w-100 m-auto">
            <form action="" method="post">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingLastname" placeholder="Ingresa tu apellido" autofocus required pattern="[A-Za-z]{8,12}"><br>
                    <label for="floatingLastname">Apellido:</label>
                </div>

                <div class="form-floating">
                    <input type="email" class="form-control" id="floatingEmail" placeholder="Ingresa tu correo" autofocus required pattern="[A-Za-z]{8,12}"><br>
